"use strict";
(self["webpackChunk_degenfrens_swapper"] = self["webpackChunk_degenfrens_swapper"] || []).push([[448],{
...
/* harmony import */ var _index_2c50352f_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(18660);
...
function transformSwapRouteToGetQuoteResult(_ref) {
    ...
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      if (subRoute.protocol === _uniswap_router_sdk__WEBPACK_IMPORTED_MODULE_5__.Protocol.V3) {
        ...
        for (var i = 0; i < pools.length; i++) {
          ...
          if (i === 0) {
            edgeAmountIn = (0,_index_2c50352f_js__WEBPACK_IMPORTED_MODULE_3__.i)(tradeType) ? _amount.quotient.toString() : _quote.quotient.toString();
          }

          var edgeAmountOut = undefined;

          if (i === pools.length - 1) {
            edgeAmountOut = (0,_index_2c50352f_js__WEBPACK_IMPORTED_MODULE_3__.i)(tradeType) ? _quote.quotient.toString() : _amount.quotient.toString();
          }
        ...
        for (var _i = 0; _i < _pools.length; _i++) {
          ...
          if (_i === 0) {
            _edgeAmountIn = (0,_index_2c50352f_js__WEBPACK_IMPORTED_MODULE_3__.i)(tradeType) ? _amount.quotient.toString() : _quote.quotient.toString();
          }

          var _edgeAmountOut = undefined;

          if (_i === _pools.length - 1) {
            _edgeAmountOut = (0,_index_2c50352f_js__WEBPACK_IMPORTED_MODULE_3__.i)(tradeType) ? _quote.quotient.toString() : _amount.quotient.toString();
          }
  ...
  var amount = (0,_index_2c50352f_js__WEBPACK_IMPORTED_MODULE_3__.i)(tradeType) ? inputAmount : outputAmount;
  return {
    state: _index_2c50352f_js__WEBPACK_IMPORTED_MODULE_3__.Q.SUCCESS,
    data: {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            tokenInIsNative = Object.values(_index_2c50352f_js__WEBPACK_IMPORTED_MODULE_3__.S).includes(tokenIn.address);
            tokenOutIsNative = Object.values(_index_2c50352f_js__WEBPACK_IMPORTED_MODULE_3__.S).includes(tokenOut.address);
            currencyIn = tokenInIsNative ? (0,_index_2c50352f_js__WEBPACK_IMPORTED_MODULE_3__.n)(tokenIn.chainId) : new _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_1__.Token(tokenIn.chainId, tokenIn.address, tokenIn.decimals, tokenIn.symbol);
            currencyOut = tokenOutIsNative ? (0,_index_2c50352f_js__WEBPACK_IMPORTED_MODULE_3__.n)(tokenOut.chainId) : new _uniswap_sdk_core__WEBPACK_IMPORTED_MODULE_1__.Token(tokenOut.chainId, tokenOut.address, tokenOut.decimals, tokenOut.symbol);
            baseCurrency = (0,_index_2c50352f_js__WEBPACK_IMPORTED_MODULE_3__.i)(tradeType) ? currencyIn : currencyOut;
            quoteCurrency = (0,_index_2c50352f_js__WEBPACK_IMPORTED_MODULE_3__.i)(tradeType) ? currencyOut : currencyIn;
          ...
          case 10:
            ...
            return _context.abrupt("return", {
              state: _index_2c50352f_js__WEBPACK_IMPORTED_MODULE_3__.Q.INITIALIZED
            });
          ...
          case 13:
            ...
            return _context.abrupt("return", {
              state: _index_2c50352f_js__WEBPACK_IMPORTED_MODULE_3__.Q.NOT_FOUND
            });
